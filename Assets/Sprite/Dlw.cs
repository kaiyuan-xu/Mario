...
public class Dlw : MonoBehaviour
{
    ...
    private void RandomAction()
    {
        ...
        float number = UnityEngine.Random.Range(0, actionWeight[0] + actionWeight[1] + actionWeight[2]);
    ...
    private void Attack_Dlw()
    {
        if(attack==false)
        {
            Instantiate(ft, transform.position, Quaternion.identity);
            attack = true;
        }
    }
